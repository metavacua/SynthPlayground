...
class Inl:
    ...
    def __eq__(self, other):
        return (
            isinstance(other, Inl)
            and self.e == other.e
            and self.t_right == other.t_right
        )
...
class Inr:
    ...
    def __eq__(self, other):
        return (
            isinstance(other, Inr) and self.e == other.e and self.t_left == other.t_left
        )
...
class Case:
    ...
    def __repr__(self):
        return (
            f"Case({self.e}, inl({self.v1}) => {self.e1}, inr({self.v2}) => {self.e2})"
        )
