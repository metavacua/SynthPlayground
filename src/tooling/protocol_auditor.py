...
def main():
    ...
    import argparse
    parser = argparse.ArgumentParser(description="Protocol Auditor")
    parser.add_argument("--output-file", default=os.path.join(ROOT_DIR, "audit_report.md"), help="Path to save the audit report.")
    # The --source-dir argument is kept for compatibility with builder.py, but not used directly
    ...
    print(
        f"--- Audit Complete. Report generated at: {args.output_file} ---", file=sys.stderr
    )
