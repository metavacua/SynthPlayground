...
This module is defined by the protocols in its corresponding `AGENTS.md` file.
...
```json
{
  ...
  "@type": "agents:Module",
  "hasMember": {
    "@id": "agents:compliance/AGENTS.md"
  }
}
```
...
```json
{
  ...
  "@type": "agents:Module",
  "hasMember": {
    "@id": "agents:critic/AGENTS.md"
  }
}
```

### Child Module: `security`

This module includes protocols from its child module `security`, as summarized below:
This module is defined by the protocols in its corresponding `AGENTS.md` file.
