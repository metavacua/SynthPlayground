...
# --- Configuration ---
# Assuming this script is in protocols/self_improvement/, the root is two levels up.
...
def compile_module():
    ...
    print(f"--- Starting Protocol Compilation for Self-Improvement Module ---")
    ...
    print(f"Successfully compiled AGENTS.md for self-improvement module at {TARGET_FILE}")
