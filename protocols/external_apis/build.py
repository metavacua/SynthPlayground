...
# --- Configuration ---
# Assuming this script is in protocols/external_apis/, the root is two levels up.
...
def compile_module():
    ...
    print(f"--- Starting Protocol Compilation for External APIs Module ---")
    ...
    print(f"Successfully compiled AGENTS.md for external_apis module at {TARGET_FILE}")
