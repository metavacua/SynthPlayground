...
class Parser:
    def __init__(self, lexer):
        ...
        self.infix_parse_fns = {
            ...
            "MUL": self.parse_infix_expression,
            "DIV": self.parse_infix_expression,
            ...
            "IN": self.parse_infix_expression,
    ...
    def parse_expression(self, precedence):
        ...
        left_exp = prefix()
        while (
            self.peek_token.type != "SEMICOLON" and precedence < self.peek_precedence()
        ):
    ...
    def parse_identifier(self):
        return Identifier(value=self.current_token.value)

    def parse_integer_literal(self):
        return IntegerLiteral(value=int(self.current_token.value))

    def parse_string_literal(self):
        return StringLiteral(value=self.current_token.value)
    ...
    def parse_function_parameters(self):
        ...
        if self.current_token.type != "ID":
            self.errors.append(
                f"Expected parameter name to be an identifier, got {self.current_token.type}"
            )
