...
class Logger:
    ...
    def __init__(
        ...
        Args:
            schema_path (str): Path to the Markdown file for the logging schema.
    ...
    def _load_schema(self, schema_path):
        ...
        try:
            ...
            print(
                f"Warning: Could not load or parse schema from {schema_path}. "
                f"Logger will operate without schema validation. Error: {e}"
            )
            return None
    ...
    def log(
        ...
        Args:
            ...
            outcome_message (str, optional): A message describing the outcome.
                Defaults to "".
            error_details (dict, optional): Structured error info if the
                outcome is a failure. Defaults to None.
            evidence (str, optional): Citation for the action. Defaults to "".

        Raises:
            ValidationError: If the generated log entry does not conform to the
                schema.
        """
        log_entry = {
