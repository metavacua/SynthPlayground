...
class TestBuilder(unittest.TestCase):
    ...
    def test_execute_compiler_target(self, mock_run):
        ...
        # Add a space at the end to match the actual command
    ...
    def test_execute_command_target(self, mock_run):
        ...
        # The trailing space is intentional to match the command in the config
    ...
    def test_build_group_execution(self, mock_execute_build):
        ...
        calls = [
            call("compile", self.build_config, []),
            call("test", self.build_config, []),
        ]
