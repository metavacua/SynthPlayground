...
def patch_atom_values(node, context_values, pda_parser_context):
    """
    ...
    if node_type == "atom":
        ...
        return (node_type, op, patch_atom_values(child, context_values, pda_parser_context))
    elif node_type == "binary_op":
        op, left, right = node[1], node[2], node[3]
        return (
            node_type,
            op,
            patch_atom_values(left, context_values, pda_parser_context),
            patch_atom_values(right, context_values, pda_parser_context),
        )
    return node
