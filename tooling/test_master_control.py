...
class TestMasterControlGraphFullWorkflow(unittest.TestCase):
    ...
    def test_full_atomic_workflow_with_analysis(self):
        ...
        # 9. Assertions
        self.assertIn('final_state', final_state_container, "Final state object was not captured.")
        ...
        self.assertIn('final_fsm_state', final_state_container, "Final FSM state was not captured.")
