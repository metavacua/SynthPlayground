...
IGNORE_EXTENSIONS = {'.pyc', '.pyo', '.pyd', '.so', '.egg', '.png', '.jpg', '.jpeg', '.gif'}
    ...
    if args.command == "scan":
        ...
        if not placeholders:
            ...
            for p in placeholders:
                print(f"  - [{p['task_id']}] {p['description']} ({p['file']}:{p['line']})")
        ...
        if not non_compliant_todos:
            ...
            print(f"\nValidation FAILED: Found {len(non_compliant_todos)} non-compliant TODO(s):")
