...
class TestResearchExecutor(unittest.TestCase):
    ...
    def test_local_filesystem_file_scope(
        self,
        mock_read_file,
        mock_list_files,
        mock_google_search,
        mock_view_text_website,
    ):
    ...
    def test_local_filesystem_directory_scope(
        self,
        mock_read_file,
        mock_list_files,
        mock_google_search,
    ...
    def test_external_web_narrow_scope(
        self,
        mock_read_file,
        mock_list_files,
        mock_google_search,
    ...
    def test_external_web_broad_scope(
        self,
        mock_read_file,
        mock_list_files,
        mock_google_search,
    ...
    def test_external_repository_scope(
        self,
        mock_read_file,
        mock_list_files,
        mock_google_search,
