...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyzes agent activity logs for improvement areas."
    )
    parser.add_argument(
        "--log-file",
    ...
    if not inefficient_tasks:
        print(
            "\nAnalysis Complete: No tasks with significant planning "
            "inefficiencies found."
        )
    else:
        print(
            "\nAnalysis Complete: Found tasks with multiple plan revisions, "
