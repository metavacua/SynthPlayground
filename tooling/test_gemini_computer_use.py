...
class TestGeminiComputerUse(unittest.TestCase):
    ...
    def test_main(self, mock_generative_model, mock_gemini_api_client, mock_sync_playwright):
        ...
        mock_candidate.content.parts = [MagicMock(function_call=None, text="Task complete")]
