...
class TestBuilder(unittest.TestCase):
    ...
    def test_execute_compiler_target(self, mock_run):
        ...
        expected_command = ['python3', os.path.join(self.test_dir, 'tooling/compiler.py'), '--source-dir', os.path.join(self.test_dir, 'sources/'), '--output-file', os.path.join(self.test_dir, 'output/all.md')]
    ...
    def test_execute_command_target(self, mock_run):
        ...
        mock_run.assert_called_once_with(
            ...
            check=True, capture_output=True, text=True, cwd=self.test_dir, shell=True
        )
