...
from tooling.context_awareness_scanner import get_defined_symbols, get_imported_symbols, find_references, main as scanner_main
...
class TestContextAwarenessScanner(unittest.TestCase):
    ...
    @patch('sys.argv', new_callable=lambda: ['tooling/context_awareness_scanner.py', 'test_context_scanner_dir/file_to_scan.py', '--search-path', 'test_context_scanner_dir'])
